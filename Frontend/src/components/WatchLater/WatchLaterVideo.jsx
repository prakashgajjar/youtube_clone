...
const likedVideos = ({ video, channelName }) => {
    ...
    return (
        <div className="">
            <div className=" h-[138px] w-[1266px] flex justify-between  ">
                    ...
                    <div className="pt-1 w-[514px]">
                        <div className="flex justify-between">
                            ...
                            <div className="flex ml-3">
                                <div className="flex justify-center w-10 h-10 items-center cursor-pointer " onClick={()=>{
                                ...
                                </div>
{
                                 showOption && <div className="ml-2 absolute mt-10 cursor-pointer w-48 text-white bg-[#282828] shadow-gray-600 rounded-xl  shadow-sm">
                                  <Options isWatchlaterPage={true} video={video} value={setShowOption} />
                              </div>
}
                            </div>
                        </div>
